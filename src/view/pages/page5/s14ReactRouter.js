...
const ReactRouter = ({title}) => {
	return (
		<div className="page-layout">
			...
			<h2 className="h2">
				1. react-router / react-router-domとは
			</h2>
				<p className="p">
					URLにパスを付与してルーティングできるようにするライブラリ
				</p>
			...
			<h2 className="h2">
				...
				<p className="p">
					<span className="command">
						$ npm install react-router --save / $ npm install react-router-dom --save
					</span>
				</p>
				<p className="p">
					「--save」と付けることで、package.jsonに「react-router / react-router-dom」が追加
				</p>
